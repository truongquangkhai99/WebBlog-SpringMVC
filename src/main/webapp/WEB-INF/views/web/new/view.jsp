...
<body>
    <div class="row jumbotron jumbotron-fluid rounded">
        <div class="col-lg-9">
            ...
            <mark>
            	Thể loại : <c:out value="${category.name}" />
            </mark>
            <br><br><br>
            <blockquote class="blockquote">
                ...
                <hr>
                <p>${model.content}</p>
                <footer class="blockquote-footer">Người viết :
                    <c:out value="${model.createdBy}" />
                </footer>
                <footer class="blockquote-footer">Ngày tạo :
                    <c:out value="${model.createdDate}" />
                </footer>
            </blockquote>
            <h3>Bình Luận</h3>
                ...
                <c:forEach var="item" items="${listComments}">
                    <div class="media">
                        <div class="media-body">
                            ...
                            <small>
                                <c:out value="${item.createdDate}" /></small>
                        </div>
                    </div>
                    <br><br><br>
                </c:forEach>
