			...
			function deleteRole(data) {
				$.ajax({
					...
					success: function (result) {
						window.location.href = "${RoleURL}?limit=5&page=1&message=delete_success&alert=success";
					},
					error: function (error) {
						window.location.href = "${RoleURL}?limit=5&page=1&message=error_system&alert=danger";
					}
				});
			}
